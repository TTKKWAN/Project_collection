        ...
        children: [
          (widget.data['photos'][0].contains("photo"))
              ...
              : Image.file(File(widget.data['photos'][0]),
                  ...
                  //     3 /
                  //     10, // ?ó¨Í∏? ?Öç?ä§?ä∏ Î∂?Î∂? Í∞?Î°?
                  // height: MediaQuery.of(context).size.width * 3 / 10,
                  ), // ?ùº?ã® ?Ç¨Ïß? ?ÇΩ?ûÖ?ï† Î∂?Î∂? Ï≤¥ÌÅ¨
          const SizedBox(width: 10),
          Container(
              width: MediaQuery.of(context).size.width * 1 / 2, // ?ó¨Í∏?
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                    widget.data['title'], ///////// ?ó¨Í∏∞Í?? ?†úÎ™?
                  ...
                  Flexible(
                    ...
                    maxLines: 3,
                    text: TextSpan(
                        text: widget.data['content'], /////////// ?ó¨Í∏∞Í?? Î≥∏Î¨∏
                        style: TextStyle(
                            color: Colors.black,
...
class _detailPageState extends State<detailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            Padding(
              ...
              child: Container(
                ...
                children: [
                  const SizedBox(width: 5),
                  Flexible(
                    child: Text(widget.data['content'], /////////// ?ó¨Í∏∞Í?? Î≥∏Î¨∏
                        style: TextStyle(
                            color: Colors.black,
                            fontFamily: 'NanumSquareRegular')),
                  ),
                        ...
                        if (commentInput.text.isNotEmpty) {
                          setState(() {
                            widget.addComment(commentInput
                                .text); // ?ó¨Í∏∞Ïóê ?åìÍ∏?Ï∂îÍ?? ?ï®?àò ÏßëÏñ¥?Ñ£?úºÎ©? ?ê†?ìØ.
                          });
                        }
                      },
                      child: Text('Send'),
      ...
      //                   setState(() {
      //                     widget.addComment(
      //                         commentInput.text); // ?ó¨Í∏∞Ïóê ?åìÍ∏?Ï∂îÍ?? ?ï®?àò ÏßëÏñ¥?Ñ£?úºÎ©? ?ê†?ìØ.
      //                   });
      //                 }
      //               },
      //               child: Text('Send'),
...
// SliverToBoxAdapter(child: Text('This is photo place')),
          ...
          //       width: MediaQuery.of(context).size.width * 1.5 / 10,
          //     ),
          // widget.data['photo'].length > 1 ////////////// ?ïò?ïÑ
          //     ? Image.file(
